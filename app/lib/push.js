...
exports.init = function (){
    if(Titanium.Network.online){
        ACS_retrieveDeviceToken();
    }
    else{
        setTimeout(exports.init, 60000);
        retry++;
    }
}
...
var ACS_suscribeChannel = function(){
    Cloud.PushNotifications.subscribeToken({
        ...
        if (e.success) {
            ...
            Ti.API.debug('PUSHGCM - ACS - Channel subscribed NOK:' + JSON.stringify(e));
        }
    });
}
...
var ACS_unsuscribeChannel = function(){
    Cloud.PushNotifications.unsubscribeToken({
        ...
        if (e.success) {
            Ti.API.debug('PUSHGCM - ACS - Sucess Logout on PUSH platform: ' + JSON.stringify(e));
        }
    });
}
